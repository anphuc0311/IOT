...
elseif(WIN32)
  set(TOOLCHAIN_DIR "D:/SI/developer/toolchains/gnu_arm/12.2.rel1_2023.7//bin/")
elseif(APPLE)
...
elseif(WIN32)
  set(POST_BUILD_EXE "D:/SI/developer/adapter_packs/commander/commander.exe")
elseif(APPLE)
  set(POST_BUILD_EXE "")
else()
  set(POST_BUILD_EXE "")
...
elseif(WIN32)
  set(NINJA_RUNTIME_PATH "D:/SI/developer/adapter_packs/ninja/ninja.exe")
elseif(APPLE)
