...
#ifndef SL_SPIDRV_INST_CONFIG_H
#define SL_SPIDRV_INST_CONFIG_H
...
// <i> Default: 8
#define SL_SPIDRV_INST_FRAME_LENGTH      8

// <o SL_SPIDRV_INST_TYPE> SPI mode
// <spidrvMaster=> Master
// <spidrvSlave=> Slave
#define SL_SPIDRV_INST_TYPE              spidrvSlave

// <o SL_SPIDRV_INST_BIT_ORDER> Bit order on the SPI bus
// <spidrvBitOrderLsbFirst=> LSB transmitted first
// <spidrvBitOrderMsbFirst=> MSB transmitted first
#define SL_SPIDRV_INST_BIT_ORDER         spidrvBitOrderMsbFirst

// <o SL_SPIDRV_INST_CLOCK_MODE> SPI clock mode
...
#define SL_SPIDRV_INST_CLOCK_MODE        spidrvClockMode0
...
#define SL_SPIDRV_INST_SLAVE_START_MODE  spidrvSlaveStartImmediate
// </h>
...
#define SL_SPIDRV_INST_PERIPHERAL                USART1
#endif
#ifndef SL_SPIDRV_INST_PERIPHERAL_NO            
#define SL_SPIDRV_INST_PERIPHERAL_NO             1
#endif

// USART1 TX on PC12
#ifndef SL_SPIDRV_INST_TX_PORT                  
#define SL_SPIDRV_INST_TX_PORT                   SL_GPIO_PORT_C
#endif
#ifndef SL_SPIDRV_INST_TX_PIN                   
#define SL_SPIDRV_INST_TX_PIN                    12
#endif

// USART1 RX on PC13
#ifndef SL_SPIDRV_INST_RX_PORT                  
#define SL_SPIDRV_INST_RX_PORT                   SL_GPIO_PORT_C
#endif
#ifndef SL_SPIDRV_INST_RX_PIN                   
#define SL_SPIDRV_INST_RX_PIN                    13
#endif

// USART1 CLK on PC11
#ifndef SL_SPIDRV_INST_CLK_PORT                 
#define SL_SPIDRV_INST_CLK_PORT                  SL_GPIO_PORT_C
#endif
#ifndef SL_SPIDRV_INST_CLK_PIN                  
#define SL_SPIDRV_INST_CLK_PIN                   11
#endif

// USART1 CS on PC10
#ifndef SL_SPIDRV_INST_CS_PORT                  
#define SL_SPIDRV_INST_CS_PORT                   SL_GPIO_PORT_C
#endif
#ifndef SL_SPIDRV_INST_CS_PIN                   
#define SL_SPIDRV_INST_CS_PIN                    10
#endif
// [USART_SL_SPIDRV_INST]$
// <<< sl:end pin_tool >>>

#endif // SL_SPIDRV_INST_CONFIG_H
